...
try
{
	...
	System.out.println("Connection Established");
	 PreparedStatement pstmt = con.prepareStatement("select * from addflight where ffrom=? and fto=?");
	  ...
	  ResultSet rs = pstmt.executeQuery();
	  	  ...
	  	  if(rs.next())
	  {
		int cost1=rs.getInt("cost")*Integer.parseInt(rseats);
		System.out.println(cost1);
		session.setAttribute("cost",cost1);
		session.setMaxInactiveInterval(10);
		System.out.println("Total Cost is:"+cost1);
		PreparedStatement pst2=con .prepareStatement("select remainingseats from addflight where ffrom='"+rfrom+"' and fto='"+rto+"'");
		...
		PreparedStatement pst1=con .prepareStatement("update addflight set remainingseats="+remseats+" where ffrom='"+rfrom+"' and fto='"+rto+"'");
		pst1.executeUpdate();
